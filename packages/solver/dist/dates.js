 ...
 */
export function nextDateFromDayOfMonth(dayOfMonth, referenceDate) {
 ...
 */
export function getNextStatementCloseDate(dayOfMonth, referenceDate) {
 ...
 */
export function getNextDueDate(dayOfMonth, referenceDate) {
    return toIsoDate(nextDateFromDayOfMonth(dayOfMonth, referenceDate));
}
